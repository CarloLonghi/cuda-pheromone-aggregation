...
int main(int argc, char* argv[]) {
    ...
    initAttractiveAndRepulsivePheromoneGrid<<<gridSize, blockSize>>>(attractive_pheromone, repulsive_pheromone, agent_count_grid3);
    ...
    for (int i = 0; i < N_STEPS; ++i) {
        ...
        //update all grids
        updateGrids<<<gridSize, blockSize>>>(attractive_pheromone, repulsive_pheromone, agent_count_grid, agent_count_grid3, worm_count, d_agents,

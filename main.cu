...
int main(int argc, char* argv[]) {
    ...
    int worm_count = WORM_COUNT, * agent_count_grid, * h_agent_count_grid = new int[N * N];;
    ...
    if (argc - 1 == 9){
        ...
        std::cout << "The number of parameters is incorrect, it should be 8 but is " << argc - 1 << std::endl;
        return 1;
    }
